...
var searchWeatherfn = async function() {
    ...
    document.getElementById("svg_w").src = "img/weather/icons/" + svg_icon + ".svg";
    // 切换背景色
    var bobyEI = document.body;
    // var bobyEI = document.getElementById("weather")
    svg_icon = parseInt(svg_icon);
    if (100 <= svg_icon && svg_icon < 101) {
        bobyEI.style = "background: url(img/weather/sun.webp) no-repeat; background-size: cover;"
    } else if (101 <= svg_icon && svg_icon < 104) {
        bobyEI.style = "background: url(img/weather/yun.webp) no-repeat; background-size: cover;"
    } else if (104 <= svg_icon && svg_icon < 150) {
        bobyEI.style = "background: url(img/weather/yin.webp) no-repeat; background-size: cover;"
    } else if (150 <= svg_icon && svg_icon < 300) {
        bobyEI.style = "background: url(img/weather/night.webp) no-repeat; background-size: cover;"
    } else if (300 <= svg_icon && svg_icon < 400) {
        bobyEI.style = "background: url(img/weather/yu.webp) no-repeat; background-size: cover;"
    } else if (400 <= svg_icon && svg_icon < 500) {
        bobyEI.style = "background: url(img/weather/xue.webp) no-repeat; background-size: cover;"
    } else {
        bobyEI.style = "background: url(img/weather/yun.webp) no-repeat; background-size: cover;"
    }
}
